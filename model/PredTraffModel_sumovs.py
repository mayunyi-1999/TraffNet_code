...
from model.TemporalGRU_sumovs import TemperalGRU_sumovs


class PredTraffModel_sumovs(nn.Module):
    def __init__(self, seq_max_len, edge_num, window_width,batch_size, horizon):
        super(PredTraffModel_sumovs, self).__init__()
        ...
        self.RouteLearningModel = RouteLearningModel(in_feats=400 * 2,
                                                     out_feats=1024,
                                                     num_heads=2,
        ...
        self.gru = TemperalGRU_sumovs(in_size=400 * 2,
                               hidden_size=1200,
                               num_layers=2,
