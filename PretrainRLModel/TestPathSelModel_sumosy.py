...
np.savez('pathCount_pretrain_sumosy.npz', pathCountNumpy)
np.savez('pathPredCount_pretrain_sumosy.npz', pathPredCountNumpy)
np.savez('pathSelProb_pretrain_sumosy.npz', pathSelProbNumpy)
print(f'total_loss:{total_loss}')
